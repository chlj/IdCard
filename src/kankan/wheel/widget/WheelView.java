...
//	private static final int[] SHADOWS_COLORS = new int[] { R.color.selected_middle,
//		R.color.selected_middle, R.color.selected_middle };
...
//					SHADOWS_COLORS);
			...
			topShadow.setColor(getResources().getColor(R.color.selected_middle)); //top
		}
...
//					SHADOWS_COLORS);
			...
			bottomShadow.setColor(getResources().getColor(R.color.selected_middle)); //button
		}

		
		//setBackgroundResource(R.drawable.wheel_bg);
		
		setBackgroundResource(R.color.top_botton_while); // view background
	}
